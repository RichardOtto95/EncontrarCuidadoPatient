            ...
            child: Row(
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  backgroundImage:
                      store.userAvatar == null || store.userAvatar == ''
                          ? AssetImage('assets/img/defaultUser.png')
                          : NetworkImage(store.userAvatar),
                ),
              ],
            ),
          )
                        ...
                        child: Row(
                          ...
                          children: [
                            CircleAvatar(
                              radius: wXD(30, context),
                              backgroundImage:
                                  store.drAvatar == null || store.drAvatar == ''
                                      ? AssetImage('assets/img/defaultUser.png')
                                      : NetworkImage(store.drAvatar),
                            ),
                            SizedBox(
                              width: wXD(11, context),
                            ),
                        ...
                        ? Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                CircleAvatar(
                                  radius: wXD(30, context),
                                  backgroundImage: store.drAvatar == null ||
                                          store.drAvatar == ''
                                      ? AssetImage('assets/img/defaultUser.png')
                                      : NetworkImage(store.drAvatar),
                                ),
