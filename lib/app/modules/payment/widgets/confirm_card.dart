...
class ConfirmCard extends StatelessWidget {
  ...
  ConfirmCard({this.onConfirm, this.onBack, this.text, this.svgWay});
      ...
      child: Material(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            padding: EdgeInsets.only(top: wXD(72, context)),
            alignment: Alignment.topCenter,
            child: Stack(
              alignment: Alignment.center,
              children: [
                Container(
                  margin: EdgeInsets.only(top: wXD(45, context)),
                  width: wXD(324, context),
                  height: wXD(301, context),
  ...
  // @override
  // WidgetBuilder get builder => (BuildContext context) => Positioned(
  //       child: Material(
  //         color: Colors.transparent,
  //         child: GestureDetector(
  //           onTap: onConfirm,
  ...
  //             height: maxHeight(context),
  //             width: maxWidth(context),
  //             margin: EdgeInsets.only(top: wXD(123, context)),
  //             alignment: Alignment.topCenter,
  //             child: Container(
  //               width: wXD(324, context),
  //               height: wXD(297, context),
  //               decoration: BoxDecoration(),
  //             ),
  //           ),
  //         ),
